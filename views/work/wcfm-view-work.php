...
$count_work['any']     = $count_work['publish'] + $count_work['pending'] + $count_work['draft'];

?>

<div class="collapse wcfm-collapse" id="wcfm_work_listing">

	<div class="wcfm-page-headig">
		<span class="wcfmfa fa fa-work"></span>
		<span class="wcfm-page-heading-text"><?php _e( 'works', 'wcfm-cpt' ); ?></span>
		<?php do_action( 'wcfm_page_heading' ); ?>
	</div>
	<div class="wcfm-collapse-content">
		<div id="wcfm_page_load"></div>
		<?php do_action( 'before_wcfm_work' ); ?>
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			<?php	echo apply_filters( 'wcfm_work_limit_label', '' ); ?>
		...
		<div class="wcfm-container">
			<div id="wcfm_work_listing_expander" class="wcfm-content">
				<table id="wcfm-work" class="display" cellspacing="0" width="100%">
					<thead>
						<tr>
